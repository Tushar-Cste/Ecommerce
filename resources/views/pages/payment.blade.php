					...
					<tbody>
						...
						<tr>
							<td class="cart_product">
								<a href=""><img src="{{URL::to('/storage/product_images/'.$v_contents->options->image)}}" height="80px" width="80px" alt=""></a>
							</td>
					...
					<div class="paymentWrap">
						<div class="btn-group paymentBtnGroup btn-group-justified" data-toggle="buttons">
				            <label class="btn paymentMethod active">
				                ...
				                <input type="radio" name="payment" value="handcash" checked> 
				            </label>
