            ...
            <div class="product-image-wrapper">
                <div class="single-products">
                        <div class="productinfo text-center">
                            <img src="storage/product_images/{{$product->product_image}}" style="height: 250px;" alt="" />
                        ...
                        <div class="product-overlay">
                            <div class="overlay-content">
                                <h2>{{$product->product_price}} Tk</h2>
                                <p>{{$product->product_name}}</p>
                                <a href="{{URL::to('/productDetails/'.$product->id)}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                            </div>
                        </div>
                </div>
                <div class="choose">
                    <ul class="nav nav-pills nav-justified">
                        ...
                        <li><a href="{{URL::to('/productDetails/'.$product->id)}}"><i class="fa fa-plus-square"></i>view product</a></li>
                    </ul>
                </div>
            </div>
        </div>
