...
<head>
    ...
    .paymentWrap .paymentBtnGroup .paymentMethod .method.visa {
        background-image: url("{{URL::to('frontend/images/payment/handcash.png')}}");
    }

    .paymentWrap .paymentBtnGroup .paymentMethod .method.master-card {
        background-image: url("{{URL::to('frontend/images/payment/bkash_logo.png')}}");
    }

    .paymentWrap .paymentBtnGroup .paymentMethod .method.amex {
        background-image: url("{{URL::to('frontend/images/payment/paypal.jpg')}}");
    }
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                @else
                                <li><a href="{{URL::to('/loginToCheck')}}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
                                @endif
                                ...
                                @else
                                <li><a href="{{URL::to('/loginToCheck')}}"><i class="fa fa-lock"></i> Login</a></li>
                                @endif
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a  data-parent="" href="{{URL::to('/productsByCategory/'.$category->id)}}">
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li><a href="{{URL::to('/productsByManufacture/'.$manufacture->id)}}"> <span class="pull-right">(4)</span>{{$manufacture->manufacture_name}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div><!--/brands_products-->
