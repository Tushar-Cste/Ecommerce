				...
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
				  ...
				  <tbody>
					<tr>
						...
						<td class="center"><img src="/storage/slider_images/{{$slider->slider_image}}" style="width: 100px; height: 80px;" ></td>
						<td>
						...
						<td class="center">
						  @if($slider->publication_status == 1)
							...
							@endif
							<a class="btn btn-danger" href="{{URL::to('/deleteslider/'.$slider->id)}}" id="delete">
