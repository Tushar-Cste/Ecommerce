			...
			{{csrf_field()}}
			  <fieldset>
				...
				<div class="control-group">
				  ...
				  <div class="controls">
					<textarea class="cleditor" id="ProductShortDescription" name="product_short_description" rows="3"></textarea>
				  </div>
				</div>
				...
				<div class="control-group">
				  ...
				  <div class="controls">
					<textarea class="cleditor" id="ProductLongDescription" name="product_long_description" rows="5"></textarea>
				  </div>
				</div>
