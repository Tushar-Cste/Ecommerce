			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/allCategory')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> Category</span></a></li>
						<li><a href="{{URL::to('/addCategory')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Category</span></a></li>
						<li><a href="{{URL::to('/allManufacture')}}"><i class="icon-eye-open"></i><span class="hidden-tablet">Manufacture</span></a></li>
